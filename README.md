...
| `CLOUDFLARE_RECORD_ID` | yes | ID of the A record to update. Run `CLOUDFLARE_API_TOKEN=... CLOUDFLARE_ZONE_ID=... bun run cf-records` to list all A records with their IDs. |
